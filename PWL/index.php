<?php
    // 2172008 - Christopher Richard Alexander
    // 2172030 - Femmy Friscilla S.
    session_start();
...
<body>
    ...
    if ($_SESSION['registered_user']) {
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="padding-left: 30px;">
            <img src="asset/Karamik logo.png" width="50" alt="">
            <a class="navbar-brand ms-2"></a>
